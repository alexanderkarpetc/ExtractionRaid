...
| 5 | **Hotbar weapon slots** — distinct visual treatment | Slots 1-2 (weapons) rendered with different background tint / icon hint, slight separator gap before slots 3-9 (consumables). UI Toolkit, extends existing `HotbarOverlay`. |
